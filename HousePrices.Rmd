...
#### Tujuan saya menggunakan data ini adalah untuk menganalisis dan melihat fitur-fitur apa saja yang menjadi penting dalam menentukan sebuah harga rumah.
...
```
Dengan mengecek eror menggunakan RMSE (Root Mean Squared Eror) dapat lihat bahwa model yang akan melenceng dari data aktual sebanyak 5147.273
...
```
Dari hasil grafik/plot dapat dilihat bahwa model berdistribusi normal
